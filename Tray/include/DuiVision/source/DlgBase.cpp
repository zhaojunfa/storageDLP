...
BEGIN_MESSAGE_MAP(CDlgBase, CDialog)
	...
	ON_MESSAGE(WM_UI_NOTIRYDLG, OnNotifyDlg)
...
LRESULT CDlgBase::OnNotifyDlg(WPARAM wParam, LPARAM lParam)
{
	// 判断是否主窗口
	...
	// 调用事件处理对象进行处理
	DuiSystem::Instance()->CallDuiHandler(APP_IPC, L"", MSG_NOTIFY_DLG, wParam, lParam);
