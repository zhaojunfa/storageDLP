...
#define PLUGIN_NAME L"DlpExplain"

class CDuiObject;

// DUI事件处理类
class CTrayHostDlg : public CDuiHandler
{
public:
	CTrayHostDlg(void);
	virtual ~CTrayHostDlg(void);
	...
	LRESULT	OnDuiMsgInterprocessDefault(UINT uID, CString strName, UINT Msg, WPARAM wParam, LPARAM lParam);
	...
	LRESULT OnDuiMsgGridCtrlRestoreMouseUp(UINT uID, CString strName, UINT Msg, WPARAM wParam, LPARAM lParam);
	LRESULT OnDlgSetServerMouseDown(UINT uID, CString strName, UINT Msg, WPARAM wParam, LPARAM lParam);

	LRESULT OnBtnRestorageMouseDown(UINT uID, CString strName, UINT Msg, WPARAM wParam, LPARAM lParam);
	LRESULT OnDlgRefreshMouseDown(UINT uID, CString strName, UINT Msg, WPARAM wParam, LPARAM lParam);

	LRESULT OnDlgSetScanMouseDown(UINT uID, CString strName, UINT Msg, WPARAM wParam, LPARAM lParam);
	LRESULT OnDlgSetSafeMouseDown(UINT uID, CString strName, UINT Msg, WPARAM wParam, LPARAM lParam);
	LRESULT OnDlgMaxThreadMouseDown(UINT uID, CString strName, UINT Msg, WPARAM wParam, LPARAM lParam);
	LRESULT OnDlgSetIsoMouseDown(UINT uID, CString strName, UINT Msg, WPARAM wParam, LPARAM lParam);
	...
	UINT			m_uTimerTray;	// 托盘定时

	// 消息处理定义
	DUI_DECLARE_MESSAGE_BEGIN(CTrayHostDlg)
		...
		DUI_CONTROL_NAMEMSG_MESSAGE(_T("gridctrl_restorebtn"), MSG_BUTTON_UP, OnDuiMsgGridCtrlRestoreMouseUp)
		
		DUI_CONTROL_NAMEMSG_MESSAGE(_T("btn.restorage"), MSG_BUTTON_DOWN, OnBtnRestorageMouseDown)
		DUI_CONTROL_NAMEMSG_MESSAGE(_T("btn.reflesh"), MSG_BUTTON_DOWN, OnDlgRefreshMouseDown)

		DUI_CONTROL_NAMEMSG_MESSAGE(_T("btn.setserver"), MSG_BUTTON_DOWN, OnDlgSetServerMouseDown)
		DUI_CONTROL_NAMEMSG_MESSAGE(_T("btn.scandir"), MSG_BUTTON_DOWN, OnDlgSetScanMouseDown)
		DUI_CONTROL_NAMEMSG_MESSAGE(_T("btn.safedir"), MSG_BUTTON_DOWN, OnDlgSetSafeMouseDown)
		DUI_CONTROL_NAMEMSG_MESSAGE(_T("btn.isodir"), MSG_BUTTON_DOWN, OnDlgSetIsoMouseDown)
		DUI_CONTROL_NAMEMSG_MESSAGE(_T("btn.maxthread"), MSG_BUTTON_DOWN, OnDlgMaxThreadMouseDown)
